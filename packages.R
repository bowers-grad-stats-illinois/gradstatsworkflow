...
.libPaths("libs")
firstpkgs <- c("here","devtools","packrat")
...
secondpkgs <- c("clubSandwich", "lmtest", "sandwich", "knitr","broom","coin","readstata13","scales","readxl","vcd","estimatr","fabricatr","tidyverse")
...
setup.done <- "done"
write.table(setup.done,file="setup.done")
